...
private:
	...
	void send_vision_estimate(const ros::Time &stamp, const Eigen::Affine3d &tr) {
		...
		auto rpy = UAS::quaternion_to_rpy(UAS::transform_orientation_enu_ned(Eigen::Quaterniond(tr.rotation())));

//		auto rpy UAS::quaternion_to_rpy(UAS::transform_orientation_enu_ned(
