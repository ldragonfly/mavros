...
public:
	...
	void initialize(UAS &uas_)
	{
		...
		raw_sat_pub = gp_nh.advertise<std_msgs::Int16>("raw/sat_num", 10); //LYS
...
private:
	...
	void handle_gps_raw_int(const mavlink_message_t *msg, uint8_t sysid, uint8_t compid) {
		...
		auto msg_sat_num = boost::make_shared<std_msgs::Int16>();
		msg_sat_num->data = raw_gps.satellites_visible;
		raw_sat_pub.publish(msg_sat_num);
